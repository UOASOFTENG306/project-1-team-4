...
public class RestaurantFirestoreDataProvider {
    ...
    private List<Restaurant> getRestaurants() {
        ...
        Restaurant r21 = new Restaurant("22", "Butter3 Chicken Factory", "Indulge in rich Indian flavors at the Butter Chicken Factory, where aromatic spices and creamy curries bring authentic comfort to your plate.", "Auckland", new Asian(), "restaurant21", "$");
